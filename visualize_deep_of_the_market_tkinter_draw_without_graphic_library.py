...
def draw_dom_data_on_canvas (canvas, dom_data_full, end_tick_bar_to_draw):
    ...
    if canvas.winfo_width() == 1:
        maximum_with_canvas = 3000
        max_pixel_vertical = 2000
    else:
    ...
    while ((canvas_with_left > 0) and (n_tick >= 0)):
        ...
        one_pixel_equeal_n_volume = 5000
    ...
    root.after(1000, lambda: draw_dom_data_on_canvas(canvas, dom_data_full, end_tick_bar_to_draw + 1))
